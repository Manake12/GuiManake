local library = {
	...
	colors = {
		main = Color3.fromRGB(0, 180, 240),
		background = Color3.fromRGB(0, 15, 30),
		outerBorder = Color3.fromRGB(0, 15, 30),
		innerBorder = Color3.fromRGB(0, 15, 30),
		topGradient = Color3.fromRGB(0, 15, 30),
		bottomGradient = Color3.fromRGB(15, 15, 15),
		sectionBackground = Color3.fromRGB(30, 30, 30),
		section = Color3.fromRGB(0, 180, 240),
